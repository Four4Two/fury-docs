...
## fury tx gov submit-proposal committee
...
```
{
  "type": "fury/CommitteeChangeProposal",
  "value": {
    "title": "A Title",
    "description": "A description of this proposal.",
    "new_committee": {
      "type": "fury/MemberCommittee",
      "value": {
        "base_committee": {
          "id": "1",
          "description": "The description of this committee.",
          "members": [
            "fury182k5kyx9sy4ap624gm9gukr3jfj7fdx8jzrdgq"
          ],
          "permissions": [
            {
              "type": "fury/SimpleParamChangePermission",
              "value": {
                "allowed_params": [
                  {
                    "subspace": "cdp",
...
```
{
  "type": "fury/CommitteeDeleteProposal",
  "value": {
    "title": "A Title",
    "description": "A description of this proposal.",
    "committee_id": "1"
...
```
fury tx gov submit-proposal committee [proposal-file] [deposit] [flags]
```
