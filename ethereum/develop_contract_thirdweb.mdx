...
5. After modifying your contract with your desired custom logic, you may deploy it to Fury using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select `FuryEvm` as the network
