---
sidebar_position: 4
title: Develop Contract Using thirdweb
---

# Develop Contract Using thirdweb
...
5. After modifying your contract with your desired custom logic, you may deploy it to Highbury using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select `HighburyEvm` as the network
