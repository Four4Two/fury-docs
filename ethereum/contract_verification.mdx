...
module.exports = {
  networks: {
    fury: {
      url: 'https://evm.fury.black',
    },
  },
  // highlight-start
  etherscan: {
    apiKey: {
      fury: "api key is not required by the Blackfury explorer, but can't be empty",
    },
    customChains: [
      {
        network: 'fury',
        chainId: 710,
        urls: {
          apiURL: 'https://explorer.fury.black/api',
          browserURL: 'https://explorer.fury.black',
        },
      },
    ],
  },
...
3. Verify that the custom network is configured correctly, by checking if Blackfury
...
https://explorer.fury.black/address/0x52A87b0703C65a4C30657e7badc808855711CdEc#code
```
...
[explorer]: https://explorer.fury.black
