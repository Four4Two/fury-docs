...
In this tutorial we will be going over building a module in Fury to show how easy it is to build on top of the Fury ecosystem. This module will be simple in nature but will show how to set up and connect a module to Fury and can be used as a starting point for more complex modules.
