...
Check the status of the transaction by searching for your fury address on [Furya Explorer](https://explorer.fury.black).
...
Every cross-chain swap has an auditable record. In times of high network traffic, the deputy might not complete transactions immediately. If you encounter this issue, please wait patiently and your transaction should be complete or refunded after 24 hours.
...
After unstaking FURY, those coins are locked for 21 days. After that, they are released and can be used.

### Why can't I repay my CDP?

The total amount to close the position is the original loan amount plus accrued interest.

When repaying a CDP, the remaining debt balance cannot be below 10 USDF.  
If you try to repay your original principal only, the transaction will fail if the remaining interest would leave a debt balance of less than 10 USDF.
...
Check for the transaction on the balances tab in the Fury app or the tokens tab (if you're using Cosmostation wallet) and see if it was successfully completed. If not, your tokens will still be there.
...
### Why are my transactions for 10 FURY and 10 BNB showing up as 10,000,000 ufury and 1,000,000,000, bnb in Trust Wallet?

This is how the coins are represented in the source code. They represent the smallest indivisible unit of the currency.  
‍

- ufury is one -millionth (or 10^-6) of a FURY coin
- bnb is one hundred-millionth (or 10^-8) of a BNB coin

### My validator node is having problems

Please contact our team through [Discord](https://discord.gg/RpjX5C5YsB), [Telegram](https://t.me/+lt2eF98w03JjMTg1). Describe the problem in full with steps to reproduce.

Check the #validator-feed channel in Discord for information regarding the potential need for an update.

Feel free to message us and we will set up a private channel on Telegram or Slack.

### Somebody from Fury support messaged me in Telegram. Are they legitimate team members?

Blackfury team members never message first. Please report at @notoscam and block the account. The scammer might also imitate the account of a team member changing the letters in the username. If you need assistance, find the team member in the chat user list and send them a direct message.
