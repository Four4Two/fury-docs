...
The incentive module also distributes the JINX token on the Highbury blockchain. JINX tokens are distributed to two types of ecosystem participants:
...
The incentive module distributes the JINXY token on the Highbury blockchain. JINXY tokens are distributed to two types of ecosystem participants:
