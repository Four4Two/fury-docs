...
Blackfury provides tools for easily setting up a local Fury development environment for Solidity smart contract deployment and interaction.

## futool

futool enables developers to spin up a local Blackfury development environment. A dockerized local testnet with ethermint EVM can be created with:
...
[Verify your newly deployed contract on the Furya explorer](./contract_verification).
