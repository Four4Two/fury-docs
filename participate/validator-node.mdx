...
# Install go
wget https://dl.google.com/go/go1.20.2.linux-amd64.tar.gz (or latest version at https://golang.org/dl/)
...
Install Fury using `git clone`. Note that version 0.4.1 is the correct version for mainnet.
