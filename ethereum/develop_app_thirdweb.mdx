---
sidebar_position: 5
title: Develop App Using thirdweb
---
...
This document will show you how to interact with your contract deployed to Fury using React
...
### Initialize SDK On Fury

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fury
