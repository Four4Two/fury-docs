...
Check the status of the transaction by searching for your fury address on [Mintscan](https://www.mintscan.io/fury).
...
If you need to purchase additional USDF to fully close out a position:

- Swap an asset for USDF on Fury Swap
- Purchase USDF on AscendEx
- Peer-to-peer transaction through [Fury TipBot](https://furytipbot.com/)
...
Please contact our team through [Discord](https://discord.com/invite/kQzh3Uv), [Telegram](https://t.me/furylabs), or Slack. Describe the problem in full with steps to reproduce.
...
Fury team members never message first. Please report at @notoscam and block the account. The scammer might also imitate the account of a team member changing the letters in the username. If you need assistance, find the team member in the chat user list and send them a direct message.
