---
sidebar_position: 14
title: How To Import A Seed Phrase
---


**1.** Head to [**jinx.army.**](https://jinx.army/connect-wallet?returnUrl=/dashboard)

**2.** Click "Connect Wallet".

**3.** Select "Jinx" from the list of wallets.

**4.** Click "Import a wallet".

**5.** Enter your seed phrase with a space between each word and click "Next".

**6.** Name the wallet and enter a password to encrypt your wallet. **DO NOT FORGET YOUR PASSWORD** as it will not be retrievable by Jinx Wallet if you forget it. Then, click "Next".
